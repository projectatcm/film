<?php
	...
	$alltheaters = $functions->theatersByStatus('pending');
	$pageinationresult = $functions->pagenations($alltheaters,'theaters',6,'pending');
...
<?php }else { ?>
<h4 class="page-header" style="font-weight:600">Theaters Requests</h4>
<?php
