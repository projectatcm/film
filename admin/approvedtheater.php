<?php
	...
	$alltheaters = $functions->theatersByStatus('approved');
	$pageinationresult = $functions->pagenations($alltheaters,'theaters',6,'approved');
...
<?php }else { ?>
<h4 class="page-header" style="font-weight:600">Approved Theaters</h4>
<?php
