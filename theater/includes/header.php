...
$theaterdata = $functions->selectTheaterDataById($id);
$theaterdata = $theaterdata[0];
$name = $theaterdata['name'];
$email = $theaterdata['email'];
$contact = $theaterdata['contact'];
$address = $theaterdata['address'];
$location = $theaterdata['location'];
$city = $theaterdata['city'];
$state = $theaterdata['country'];
$latitude = $theaterdata['latitude'];
$longitude = $theaterdata['longitude'];
$proof = $theaterdata['proof'];
$buildingimage = $theaterdata['buildingimage'];
$screens = $theaterdata['no_of_screens'];
$status = $theaterdata['status'];
$mailverification = $theaterdata['mailverification'];
$table = 'theaters';
$loginid = $id;
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-image: none !important">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
              ...
              <li><a href="profile.php" class="text-capitalize"><i class="fa fa-fw fa-building-o"></i> View Theater Profile</a></li>
              <li><a href="seats.php" class="text-capitalize"><i class="fa fa-fw fa-star"></i> Seats</a></li>
              <li><a href="changefilm.php" class="text-capitalize"><i class="fa fa-fw fa-file-video-o"></i> Change Film</a></li>
              <li>
                  <a href="#" data-toggle="collapse" data-target="#bookings"><i class="fa fa-fw fa-th-list"></i> Bookings <i class="fa fa-fw fa-angle-down pull-right"></i></a>
