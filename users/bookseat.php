...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/vendors/seat-normalize.css" />
		<link rel="stylesheet" type="text/css" href="../css/vendors/seat-demo.css" />
		<link rel="stylesheet" type="text/css" href="../css/vendors/seat-component.css" />
		<script src="../js/vendors/seat-modernizr-custom.js"></script>
	...
	<body>
		<header class="header">
			<div class="codrops-links">
				...
				<span style="padding-left:15px">Back to Home</span>
			</a>
			</div>
		...
		<div class="container">
			<div class="cube">
				...
				<div class="rows rows--large">
					<div class="row">
						<div data-seat="Z1" class="row__seat"></div>
						<div data-seat="Z2" class="row__seat"></div>
						<div data-seat="Z3" class="row__seat"></div>
						<div data-seat="Z4" class="row__seat"></div>
						<div data-seat="Z5" class="row__seat"></div>
						<div data-seat="Z6" class="row__seat"></div>
						<div data-seat="Z7" class="row__seat"></div>
						<div data-seat="Z8" class="row__seat"></div>
						<div data-seat="Z9" class="row__seat"></div>
						<div data-seat="Z10" class="row__seat"></div>
						<div data-seat="Z11" class="row__seat"></div>
						<div data-seat="Z12" class="row__seat"></div>
						<div data-seat="Z13" class="row__seat"></div>
						<div data-seat="Z14" class="row__seat"></div>
						<div data-seat="Z15" class="row__seat"></div>
						<div data-seat="Z16" class="row__seat"></div>
						<div data-seat="Z17" class="row__seat"></div>
						<div data-seat="Z18" class="row__seat"></div>
						<div data-seat="Z19" class="row__seat"></div>
					</div>
					<div class="row">
		...
		<div class="plan" style="right:150px;">
			...
			<button class="action action--buy">Book tickets</button>
		</div><!-- /plan -->
		<button class="action action--lookaround action--disabled" arial-label="Unlook View"></button>
		<script src="../js/vendors/seat-classie.js"></script>
		<script src="../js/vendors/seat-main.js"></script>
	</body>
</html>
