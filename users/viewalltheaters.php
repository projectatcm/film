<?php
	...
	$alltheaters = $functions->allTheatersInDescendingOrder();
	$pageinationresult = $functions->pagenations($alltheaters,'theaters',6);
	$total_page_no = $pageinationresult[0];
	$pagenatedoutput = $pageinationresult[1];
	$totalcards = sizeof($pagenatedoutput);
?>
<h4 class="page-header" style="font-weight:600">All Registered Theaters</h4>
<div class="col-xs-12" style="padding-bottom: 15px;">
	<form class="" action="actions.php?action=searchtheaters" method="post">
	<div class="col-xs-10">
		<input type="text" name="search" class="form-control" placeholder="search theaters">
	</div>
	<div class="col-xs-2">
		<button type="sumbit" class="btn btn-default"><i class="fa fa-search"></i></button>
	</div>
</form>
...
<?php
foreach ($pagenatedoutput as $theaters)  {
		$id = $theaters['id'];
		$name = $theaters['name'];
